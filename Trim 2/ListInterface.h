...
public:
   ...
   /** Replaces the entry at the last position in this list.
    @post  The entry at the last position is newEntry.
    @param newEntry  The replacement entry. */
   virtual void push_back(const ItemType& newEntry) = 0;

   /** Swaping between two nodes.
    @post Nodes are being swap.
    @param Entry1, Entry2  The nodes are going to swap.   */
   virtual void swap(int pos1, int pos2) = 0;

    /** Get items in Last Node.  */
